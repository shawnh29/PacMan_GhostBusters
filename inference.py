...
class InferenceModule:
    ...
    def getObservationProb(self, noisyDistance, pacmanPosition, ghostPosition, jailPosition):
        ...
        """
        "*** YOUR CODE HERE ***"
        # if the ghost's position is the jail position, then the observation is None with
...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for pos in self.allPositions:
            ...
            self.beliefs[pos] = self.beliefs[pos] * p
    ...
    def elapseTime(self, gameState):
        ...
        """
        "*** YOUR CODE HERE ***"
        # print(self.getPositionDistribution(gameState, gameState.getPacmanPosition()))
        ...
        for pos in self.allPositions:
            ...
            for k in newDist.keys():
                discreteDist[k] = discreteDist[k] + prob * newDist[k]
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for particle in self.particles:
            ...
            for i in range(self.numGhosts):
                obsProb = self.getObservationProb(observation[i], gameState.getPacmanPosition(), particle[i], self.getJailPosition(i))
                jointProb = jointProb * obsProb
            belief_dd[particle] += jointProb
